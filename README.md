...
Существуют также `reject` колбэк для обработки ошибок и метод `.catch` в **Promises** для обработки ошибок, но я не буду вдаваться в это, поскольку существует миллиард других учебных пособий **Promises**.
